...
def test_active_experiment_uses_one_block_future_gradient_tail() -> None:
    ...
    assert config.jepa_feedback_mode == "none"
    ...
    assert train.serialized_model_config(config)["wdl_coeff"] == 0.0
