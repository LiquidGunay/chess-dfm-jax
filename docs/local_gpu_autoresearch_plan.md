...
- [x] Run the final no-compile signature diagnostic in
  ...
  cache key. It passes: all 455 abstract records share digest
  `5fc368...0817`, PyTree definitions share `775dd6...29f7`, and NNX graph
