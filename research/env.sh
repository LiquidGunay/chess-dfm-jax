...
export CHESS_DFM_MODEL_ROOT="${CHESS_DFM_REPO_ROOT}/models"
...
export UV_PROJECT_ENVIRONMENT="${CHESS_DFM_REPO_ROOT}/.venv"
...
export JAX_COMPILATION_CACHE_MAX_SIZE="${JAX_COMPILATION_CACHE_MAX_SIZE:-4294967296}"
